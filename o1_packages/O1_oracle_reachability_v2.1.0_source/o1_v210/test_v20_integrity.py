"""v2.1 integration fixtures: precommit, runtime, calibration, and axis binding."""
...
def RP(r):
    return run_primary(
        ...
        r["cal_metadata"], r["cal_results"], r["axis_package"], r["pool"],
    )
...
def test_04_preseal_refuses_existing_records():
    ...
    expect("", create_pregeneration_seal,
           ...
           r["axis_package"], r["pool"], r["records"], exc=SealViolation)
...
def test_05_extra_runtime_configuration_surface_rejected():
    ...
    create_pregeneration_seal(r["pregen"], r["manifest"], r["prov"],
                              ...
                              r["cal_results"], r["axis_package"], r["pool"])
